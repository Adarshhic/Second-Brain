...
const Signin = () => {
    ...
    return (
        <div className="relative top-30 left-50 w-275 h-125 border border-slate-400 py-12.5 px-12.5 rounded-sm overflow-hidden">
            ...
            <button
                className="mt-6 w-35 bg-black text-white py-2 rounded-full transition-all duration-300 hover:bg-blue-500 cursor-pointer hover:scale-[1.02] hover:shadow-2xl"
